...
export default async function handler(req, res) {
    ...
    const data = {
      model: "gemma:2b",
      prompt: `give mi 15 question to ${req.query.jobrole} this job role for ${req.query.level} level`,
      stream: false,
    };
...
//     const data = {
//       model: "gemma:2b",
//       prompt: `give mi 6 question to ${req.query.jobrole} this job role ${req.query.level} level`,
//       stream: false,
//     };
...
//       const timeout = 30000; // 10 seconds timeout for example
