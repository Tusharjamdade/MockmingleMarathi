// // pages/api/storeReport.js
// import dbConnect from '@/middleware/dbConnect';  // Utility to connect to MongoDB
// import Report from '@/models/Report';  // Import the Mongoose model

// // API handler to store report data
// export default async function handler(req, res) {
//   if (req.method === 'POST') {
//     const { role, email, reportAnalysis } = req.body;
// // console.log(role, email, reportAnalysis);
